...
- Резервирование
  ...
  - Инкрементальное резервное копирование - меньший объем данных для резервного копирования, более быстрое восстановление. То есть для частых ихменений данных
...
| Channel_subscriptions | По ключу (user_id) | Связана с таблицей User |
...
- Для Cassandra:
  - Java: DataStax Java Driver - официальный драйвер, предоставляющий широкий набор функций для работы с Cassandra.
